...
const cardClassNames = ['left-4 top-6', 'right-4 top-24', 'left-14 bottom-10', 'right-12 bottom-4'];
    ...
    >
      ...
      <div className="mx-auto grid max-w-6xl gap-14 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
        <div className="motion-reveal is-visible text-left">
          ...
          <h1 className="mt-6 text-5xl font-black leading-[0.96] tracking-[-0.03em] md:text-6xl lg:text-[68px]">
            ...
            <span className="block bg-gradient-to-r from-cyan-200 via-blue-200 to-violet-200 bg-clip-text text-transparent">{t.hero.title2}</span>
        ...
        <div className="relative hidden min-h-[430px] rounded-[28px] border border-white/10 bg-white/[0.03] p-6 shadow-[0_35px_90px_rgba(15,23,42,0.75)] backdrop-blur lg:block">
          ...
          {t.hero.statCards.map((card, index) => (
            <div
              key={card.title}
              className={`hero-float-card absolute w-60 rounded-2xl border border-cyan-100/20 bg-white/10 p-4 shadow-[0_0_35px_rgba(56,189,248,0.18)] backdrop-blur-xl ${cardClassNames[index] ?? ''}`}
      ...
      <div className="mx-auto mt-14 max-w-6xl border-t border-white/10 pt-8">
        ...
        <div className="mt-5 grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {t.hero.trustedByItems.map((item) => (
