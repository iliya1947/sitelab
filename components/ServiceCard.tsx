...
export default function ServiceCard({ icon, title, description, href }: ServiceCardProps) {
  return (
    <article className="group card p-8 shadow-card">
      <div className="inline-flex rounded-xl border border-white/10 bg-slate-900/90 p-3 text-3xl transition duration-300 group-hover:-translate-y-1 group-hover:border-cyan-300/50" aria-hidden>
        {icon}
      </div>
